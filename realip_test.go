...
func TestRealIP(t *testing.T) {
	for i, test := range []struct {
		...
		{"4.5.5.5:123", "NOTANIP", "4.5.5.5:123", "NOTANIP"},
		{"aaaaaa", "1.2.3.4", "aaaaaa", "1.2.3.4"},
		{"aaaaaa:123", "1.2.3.4", "aaaaaa:123", "1.2.3.4"},
		...
		{"4.5.2.3:123", "1.2.6.7,5.6.7.8,4.5.6.7,5.6.7.8,4.5.6.7,1.2.3.4", "", "1.2.6.7,5.6.7.8,4.5.6.7,5.6.7.8,4.5.6.7,1.2.3.4"},
	} {
		remoteAddr := ""
